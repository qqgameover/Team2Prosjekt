    ...
    data: {
        ...
        statistikk: {
            ...
            instanser: [
                ...
                { id: 6, parent: 2, navn: "Martin Gustavsen", userName: "martin.gustavsen@larvik.kommune.no" },
                { id: 7, parent: 2, navn: "Preben Sandvik", userName: "preben.sandvik@larvik.kommune.no" },
                { id: 8, parent: 2, navn: "Kristian Lilleskaret", userName: "kristian.lilleskaret@larvik.kommune.no"},
                { id: 9, parent: 2, navn: "Ida Amalie Hedegaard Steffens ", userName: "ida.amalie.hedegaard.steffens@larvik.kommune.no"},
                { id: 10, parent: 2, navn: "Nina Oritsland", userName: "nina.oritsland@larvik.kommune.no"},
                { id: 11, parent: 2, navn: "Stine Nesse Langemyr", userName: "stine.nesse.langemyr@larvik.kommune.no"},
                { id: 12, parent: 2, navn: "Sverre Diesen", userName: "sverre.diesen@larvik.kommune.no"},
                { id: 13, parent: 2, navn: "Kari Thorås", userName: "kari.thorsas@larvik.kommune.no"},
                { id: 14, parent: 2, navn: "Linnea Evensen Pedersen", userName: "linnea.evensen.pedersen@larvik.kommune.no"},
                { id: 15, parent: 2, navn: "Øyvind Skilbred", userName: "oyvind.skilbred@larvik.kommune.no"},
                //8A
            ],
            achievements: [],
        },
