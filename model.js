const model = {
	...
	data: {
		taskNodes: [
			...
			{ id: 2, name: 'Fysisk', parent: 1, videoUrl: 'https://www.youtube-nocookie.com/embed/my6IroYcyEI?rel=0;showinfo=0&modestbranding=1;' },
			...
			{ id: 23, name: 'Maks antall reps', parent: 8, grandparent: 2, points: 5, },
			{ id: 24, name: 'Så egen rekord', parent: 8, grandparent: 2, points: 10, },
		...
		statistikk: {
			...
			instanser: [
				...
				{ id: 29, parent: 4, points: 0, navn: "Ivar", userName: "ivar@antropolog.no" },
				{ id: 29, parent: 4, points: 0, navn: "Marius", userName: "marius@fearlessheart.no" },
			],
			achievements: [],
		},
		muligeMeldinger: [
